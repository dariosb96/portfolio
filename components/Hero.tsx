  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 relative overflow-hidden">
      ...
      <motion.h1
        ...
        className="relative z-10 text-5xl md:text-7xl font-extrabold mb-6 tracking-tight bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent"
      >
      ...
      <motion.p
        ...
        className="relative z-10 max-w-2xl text-gray-300 mb-10"
      >
      ...
      >
        <a
          href="#projects"
          className="px-6 py-3 bg-white text-black rounded-2xl hover:scale-105 transition"
        >
          View Projects
        </a>
        <a
